...
public class MainActivity extends AppCompatActivity {
    ...
    public void onbtn(View V)
    {
        ...
        if (btn.getText().equals("ANDROID COURSE")) {
            intent.putExtra("imgsrc", "android");
            intent.putExtra("textimg", "Part 1 ( Java SE)\n" +
        ...
        if (btn.getText().equals("IOS COURSE")) {
            intent.putExtra("imgsrc", "ios");
            intent.putExtra("textimg","OOP refreshment\n" +
                    "• Introduction\n" +
        ...
        if (btn.getText().equals("FULL STACK COURSE")) {
            intent.putExtra("imgsrc", "fullstack");
            intent.putExtra("textimg","•HTML\t\n" +
                    "•HTML 5 \n" +
                    "•CSS\n" +
                    "•CSS3\n" +
                    "•SASS\n" +
